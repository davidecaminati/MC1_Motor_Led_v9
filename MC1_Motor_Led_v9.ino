...
{  
  ...
  // LED potentiometers BOX
	pinMode(potenziometer_box_red,OUTPUT);
	pinMode(potenziometer_box_green,OUTPUT);

  // Buttons potentiometers BOX 
	pinMode(reset_button,INPUT_PULLUP);
	pinMode(center_button,INPUT_PULLUP);
	pinMode(sx_button,INPUT_PULLUP);
